...
const ServerTable1 = () => {
  ...
  const fetchServerData = async () => {
    try {
      ...
      const response = await fetch("http://localhost:5000/api/get-server");
  ...
  const handleSave = async (serverId) => {
    try {
      ...
      const response = await fetch(`http://localhost:5000/api/update-server/${serverId}`, {
        method: "PUT",
        headers: {
  ...
  const handleDelete = async (serverId) => {
    try {
      ...
      const response = await fetch(`http://localhost:5000/api/delete-server/${serverId}`, {
        method: "DELETE",
      });
